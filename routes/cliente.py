...
# 1. Definimos el Blueprint del cliente
cliente = Blueprint("cliente", __name__)

# 2. Pegamos la ruta que te dio el profesor
...
def ver_vehiculos():
    ...
    sql = """SELECT id,marca,modelo,anio,placa,precio,imagen FROM vehiculos WHERE estado='Disponible' ORDER BY marca"""
    cursor.execute(sql)
